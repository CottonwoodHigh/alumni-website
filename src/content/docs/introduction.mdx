...
Similarly, yes, alumniclass.com and other similar services exist, but they are all "walled-gardens", locking information behind creating an account and login, and they collect an uncomfortable amount of personal data.
...
The goal is to support high-quality webpages for each class (e.g., no more need to create Google Sites or similar).
However, we do NOT want to publish or collect any excessive personal information (e.g., information outside of contact points for class officers).
