...
The initial set of class pages and information were populated by copying the information from the [official Cottonwood Alumni page](https://schools.graniteschools.org/cottonwoodhigh/alumni/).
Classes with websites that are broken links were ommitted.
